...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['banner']) && is_file(DIR_IMAGE . $this->request->post['banner'])) {
			$data['thumb_banner'] = $this->model_tool_image->resize($this->request->post['banner'], 500, 100);
		} elseif (!empty($category_info) && is_file(DIR_IMAGE . $category_info['banner'])) {
			$data['thumb_banner'] = $this->model_tool_image->resize($category_info['banner'], 500, 100);
		} else {
			$data['thumb_banner'] = $this->model_tool_image->resize('no_image.png', 500, 100);
		}
