...
class ControllerExtensionModuleHotDeals extends Controller {
	public function index($setting) {
		...
		if ($data['products']) {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_theme') . '/template/extension/module/hot_deals.twig')) {
				return $this->load->view('extension/module/hot_deals', $data);
			}
		}
	}
}