...
class ControllerExtensionModuleMostlyViewed extends Controller {
	public function index($setting) {
		...
		if ($data['products']) {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_theme') . '/template/extension/module/mostly_viewed.twig')) {
				return $this->load->view('extension/module/mostly_viewed', $data);
			}
		}
	}
}